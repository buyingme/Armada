...
const _SPEC: Dictionary = {
	...
	Constants.InteractionFlow.SHIP_ACTIVATION: {
		...
		Constants.InteractionStep.MANEUVER_STEP: {
			...
			"allowed_commands": ["execute_maneuver", "start_displacement",
					...
					"resolve_ship_collision_damage", "resolve_thruster_fissure",
					"resolve_damaged_controls", "resolve_asteroid_overlap",
					"resolve_debris_overlap", "resolve_station_overlap",
					"resolve_ruptured_engine", "advance_activation_step",
					"end_activation"],
	...
	Constants.InteractionFlow.SQUADRON_ACTIVATION: {
		...
		Constants.InteractionStep.ACTION_CHOICE: {
			...
			"transitions": {"activate_squadron": "ACTION_CHOICE",
					...
					"complete_squadron_activation": "WAIT_FOR_SQUAD_SELECT"},
			"source": SOURCE_COMMAND_PRODUCED,
	...
	Constants.InteractionFlow.ATTACK: {
		...
		Constants.InteractionStep.ATTACK_ROLL: {
			...
			"allowed_commands": ["resolve_attack_pool_choice",
					"use_concentrate_fire_dial", "decline_concentrate_fire_dial",
					"roll_dice", "publish_attack_flow", "skip_attack"],
		...
		Constants.InteractionStep.ATTACK_DEFENSE_TOKENS: {
			...
			"allowed_commands": ["spend_defense_token", "use_ecm",
					...
					"commit_accuracy", "select_redirect_zone", "redirect_done",
					"publish_attack_flow"],
		...
		Constants.InteractionStep.ATTACK_RESOLVE_DAMAGE: {
			...
			"allowed_commands": ["resolve_damage", "resolve_immediate_effect",
					"complete_attack", "publish_attack_flow"],
			"transitions": {"resolve_damage": "ATTACK_CRITICAL_CHOICE",
					"publish_attack_flow": "ATTACK_COUNTER_CHOICE"},
			"source": SOURCE_COMMAND_PRODUCED,
			"rule_citation": "RRG Attack, resolve damage, p.2.",
		},
		Constants.InteractionStep.ATTACK_COUNTER_CHOICE: {
			"controller_role": Constants.ControllerRole.PAYLOAD_CONTROLLER,
			"modals": [Constants.ModalKind.ATTACK_COUNTER_CHOICE],
			"allowed_commands": ["counter_choice", "publish_attack_flow"],
			"transitions": {"counter_choice": "accepted: ATTACK_DECLARE; skipped: NONE/NONE"},
			"source": SOURCE_COMMAND_PRODUCED,
			"rule_citation": "RRG Squadron Keywords, Counter.",
		},
