...
> Last updated: 2026-04-28 (Phase I6c complete — legacy `NetworkInteractionState` RPC channel deleted; `interaction_flow` is the sole authoritative interaction-state surface)
