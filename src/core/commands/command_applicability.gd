...
static var _DECLARATIONS: Dictionary = {
	...
	"commit_setup_obstacle": {KEY_SCOPE: Constants.CommandScope.PHASE,
			KEY_PHASES: [Constants.GamePhase.SETUP]},
	"commit_setup_deployment": {KEY_SCOPE: Constants.CommandScope.PHASE,
			KEY_PHASES: [Constants.GamePhase.SETUP]},
