...
> **Last audit:** 2026-05-17 — Phase M10 Point-Defense Failure rule migration is complete with attacker die-colour choice via RuleRegistry, automated gates passing, and user MT pass. Network replay gates on host/client state-hash equality rather than committed network fixtures.
