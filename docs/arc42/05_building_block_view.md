...
| `FleetSetupBootstrapper` | RefCounted | `src/core/setup/fleet_setup_bootstrapper.gd` | Builds initialized `GameState` instances from setup packages, including runtime fleets, setup payload, RNG, initiative, and damage deck |
