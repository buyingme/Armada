...
static var _DECLARATIONS: Dictionary = {
	...
	"spend_defense_token": {KEY_SCOPE: Constants.CommandScope.PHASE,
			KEY_PHASES: [Constants.GamePhase.SHIP, Constants.GamePhase.SQUADRON]},
	"use_ecm": {KEY_SCOPE: Constants.CommandScope.FLOW_STEP,
			KEY_FLOW_STEPS: [_pair(Constants.InteractionFlow.ATTACK,
					Constants.InteractionStep.ATTACK_DEFENSE_TOKENS)]},
	"decline_ecm": {KEY_SCOPE: Constants.CommandScope.FLOW_STEP,
			KEY_FLOW_STEPS: [_pair(Constants.InteractionFlow.ATTACK,
					Constants.InteractionStep.ATTACK_DEFENSE_TOKENS)]},
	...
	"select_evade_die": {KEY_SCOPE: Constants.CommandScope.PHASE,
			KEY_PHASES: [Constants.GamePhase.SHIP, Constants.GamePhase.SQUADRON]},
	"reroll_attack_die": {KEY_SCOPE: Constants.CommandScope.FLOW_STEP,
			KEY_FLOW_STEPS: [_pair(Constants.InteractionFlow.ATTACK,
					Constants.InteractionStep.ATTACK_MODIFY)]},
	"skip_attack_modifier": {KEY_SCOPE: Constants.CommandScope.FLOW_STEP,
			KEY_FLOW_STEPS: [_pair(Constants.InteractionFlow.ATTACK,
					Constants.InteractionStep.ATTACK_MODIFY)]},
	"confirm_attack_dice": {KEY_SCOPE: Constants.CommandScope.FLOW_STEP,
			KEY_FLOW_STEPS: [_pair(Constants.InteractionFlow.ATTACK,
					Constants.InteractionStep.ATTACK_MODIFY)]},
