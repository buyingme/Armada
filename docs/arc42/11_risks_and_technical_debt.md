...
| TD-18 | Legacy `EffectRegistry` bridges remain for final static-guard retirement. | Medium | N18-N22 implemented Heavy, Escort, Counter, Swarm, and Bomber critical permission through RuleRegistry-backed keyword surfaces and command-backed payloads. N23 removes or quarantines the remaining runtime effect system and adds the static guard. |
