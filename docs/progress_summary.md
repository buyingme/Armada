...
| G | Command Pattern | 🔄 | GameCommand base, 17 concrete commands, 28 wired call sites, GameReplay, §4.6 P1+P2 resolved |
...
| GameCommand + CommandProcessor | G | ✅ 17 cmds, 28 sites |
