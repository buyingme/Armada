...
| GUT asserts | 5 424 |
| Failing tests | 0 |
| Last commit | `<pending>` (Phase K8b — move maneuver execute + overlap resolution + step handlers onto `ShipActivationController`) |
