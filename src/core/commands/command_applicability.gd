...
static var _DECLARATIONS: Dictionary = {
	...
	"commit_setup_obstacle": {KEY_SCOPE: Constants.CommandScope.FLOW_STEP,
			KEY_FLOW_STEPS: [_pair(Constants.InteractionFlow.SETUP,
					Constants.InteractionStep.SETUP_OBSTACLE_PLACEMENT)]},
	"commit_setup_deployment": {KEY_SCOPE: Constants.CommandScope.FLOW_STEP,
			KEY_FLOW_STEPS: [
				_pair(Constants.InteractionFlow.SETUP,
	...
	"execute_maneuver": {KEY_SCOPE: Constants.CommandScope.PHASE,
			KEY_PHASES: [Constants.GamePhase.SHIP]},
	"apply_maneuver_transform": {KEY_SCOPE: Constants.CommandScope.PHASE,
			KEY_PHASES: [Constants.GamePhase.SHIP]},
	"complete_maneuver": {KEY_SCOPE: Constants.CommandScope.PHASE,
			KEY_PHASES: [Constants.GamePhase.SHIP]},
	"commit_maneuver_obstacle_order": {KEY_SCOPE: Constants.CommandScope.PHASE,
			KEY_PHASES: [Constants.GamePhase.SHIP]},
	"resolve_ship_collision_damage": {KEY_SCOPE: Constants.CommandScope.PHASE,
			KEY_PHASES: [Constants.GamePhase.SHIP]},
	"resolve_thruster_fissure": {KEY_SCOPE: Constants.CommandScope.PHASE,
			KEY_PHASES: [Constants.GamePhase.SHIP]},
	"resolve_damaged_controls": {KEY_SCOPE: Constants.CommandScope.PHASE,
			KEY_PHASES: [Constants.GamePhase.SHIP]},
	"resolve_asteroid_overlap": {KEY_SCOPE: Constants.CommandScope.PHASE,
			KEY_PHASES: [Constants.GamePhase.SHIP]},
	"resolve_debris_overlap": {KEY_SCOPE: Constants.CommandScope.PHASE,
			KEY_PHASES: [Constants.GamePhase.SHIP]},
	"resolve_station_overlap": {KEY_SCOPE: Constants.CommandScope.PHASE,
			KEY_PHASES: [Constants.GamePhase.SHIP]},
	"resolve_ruptured_engine": {KEY_SCOPE: Constants.CommandScope.PHASE,
			KEY_PHASES: [Constants.GamePhase.SHIP]},
	...
	"begin_attack": {KEY_SCOPE: Constants.CommandScope.PHASE,
			KEY_PHASES: [Constants.GamePhase.SHIP, Constants.GamePhase.SQUADRON]},
	"resolve_attack_pool_choice": {KEY_SCOPE: Constants.CommandScope.PHASE,
			KEY_PHASES: [Constants.GamePhase.SHIP, Constants.GamePhase.SQUADRON]},
	"use_concentrate_fire_dial": {KEY_SCOPE: Constants.CommandScope.PHASE,
			KEY_PHASES: [Constants.GamePhase.SHIP]},
	"decline_concentrate_fire_dial": {KEY_SCOPE: Constants.CommandScope.PHASE,
			KEY_PHASES: [Constants.GamePhase.SHIP]},
	"roll_dice": {KEY_SCOPE: Constants.CommandScope.PHASE,
			KEY_PHASES: [Constants.GamePhase.SHIP, Constants.GamePhase.SQUADRON]},
	"spend_defense_token": {KEY_SCOPE: Constants.CommandScope.PHASE,
			KEY_PHASES: [Constants.GamePhase.SHIP, Constants.GamePhase.SQUADRON]},
	"use_ecm": {KEY_SCOPE: Constants.CommandScope.PHASE,
			KEY_PHASES: [Constants.GamePhase.SHIP, Constants.GamePhase.SQUADRON]},
	"decline_ecm": {KEY_SCOPE: Constants.CommandScope.PHASE,
			KEY_PHASES: [Constants.GamePhase.SHIP, Constants.GamePhase.SQUADRON]},
	"commit_defense": {KEY_SCOPE: Constants.CommandScope.PHASE,
			KEY_PHASES: [Constants.GamePhase.SHIP, Constants.GamePhase.SQUADRON]},
	"commit_accuracy": {KEY_SCOPE: Constants.CommandScope.PHASE,
			KEY_PHASES: [Constants.GamePhase.SHIP, Constants.GamePhase.SQUADRON]},
	"select_evade_die": {KEY_SCOPE: Constants.CommandScope.PHASE,
			KEY_PHASES: [Constants.GamePhase.SHIP, Constants.GamePhase.SQUADRON]},
	"reroll_attack_die": {KEY_SCOPE: Constants.CommandScope.PHASE,
			KEY_PHASES: [Constants.GamePhase.SHIP, Constants.GamePhase.SQUADRON]},
