...
| TD-7 | `game_board.gd` is 3 390 lines / 157 functions — classic God Object | **High** | Refactoring Phases C + F — extract 6 isolated clusters, then backbone via ActivationContext. |
