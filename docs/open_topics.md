...
| I6b-4b | Squadron-displacement projection: `UIProjector` returns `ModalKind.DISPLACEMENT` when flow is active and viewer is controller; `DisplacementController` subscribes to projection. | ⏳ |
