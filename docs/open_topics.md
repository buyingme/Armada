...
| I6b-4c | Squadron-displacement call-site swap: `_finalize_maneuver_execute` submits `StartDisplacementCommand`; `DisplacementController._on_committed` submits `CommitDisplacementCommand`. | ⏳ |
